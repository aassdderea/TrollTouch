...
TrollTouch_FILES = main.m AppDelegate.m ViewController.m TTAXController.m
...
TrollTouch_CODESIGN_FLAGS = -Pentitlements.plist

include $(THEOS_MAKE_PATH)/application.mk

ipa: TrollTouch
	ldid -Pentitlements.plist $(THEOS_OBJ_DIR)/TrollTouch.app/TrollTouch 2>/dev/null || true
